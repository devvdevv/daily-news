...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
		<div class="container">
			<a class="navbar-brand" href="/dailynews/home">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<c:if test="${not empty USERMODEL}">
						<div class="btn-group">
							...
							<div class="dropdown-menu">
								...
								<a class="dropdown-item" href="/dailynews/escape?action=logout">Logout</a>
							</div>
						</div>
					</c:if>
					<c:if test="${empty USERMODEL}">
						...
						<a class="btn btn-outline-dark" href="/dailynews/enter?action=login" role="button">Login</a>
					</c:if>
				</ul>
			</div>
		</div>
